package com.louis.apitestbackend.interceptor;
...
import com.louis.apitestbackend.annotation.PassToken;
...
public class AuthenticationInterceptor implements HandlerInterceptor{
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object object) throws Exception {
        ...
        if (method.isAnnotationPresent(PassToken.class)) {
            PassToken passToken = ((Method) method).getAnnotation(PassToken.class);
        ...
        if (method.isAnnotationPresent(LoginToken.class)) {
            ...
            if (userLoginToken.required()) {
                ...
                Customer customer = customerService.findCustomerById(Long.valueOf(customerId));
                if (customer == null) {
